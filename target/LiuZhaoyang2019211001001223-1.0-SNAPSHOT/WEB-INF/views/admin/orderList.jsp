			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.LiuZhaoyang.model.Order o=(com.LiuZhaoyang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiuZhaoyang.dao.UserDao userDao=new com.LiuZhaoyang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LiuZhaoyang.model.Payment.findByPaymentId(con,n);
							 %>
